...
void* rt_realloc(void* ptr, uint16_t size)
{
	return tlsf_realloc(tlsf_handle, ptr, size);
}
void* rt_memalign(uint16_t num, uint16_t size)
{
	return tlsf_memalign(tlsf_handle, num, size);
}
